            ...
            <div className="about__content">
                ...
                <div className="about__details">
                    ...
                    <div className="about__socials">
                        <a href="" className="about__social-link"><i className="ri-instagram-line about__social-link"></i></a>
                        <a href="" className="about__social-link"><i className="ri-facebook-line about__social-link"></i></a>
